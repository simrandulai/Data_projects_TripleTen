...
| 3 | [P1.png](https://github.com/simrandulai/Data_projects_TripleTen/blob/main/Shopify/Shopify.pdf) | A .pdf file with screenshots of the 3 page Power BI Dashboards of my project. |
